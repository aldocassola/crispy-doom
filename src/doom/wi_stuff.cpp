...
void WI_loadData(void)
{
    ...
    // your face
    star = static_cast<decltype(star)>(W_CacheLumpName(DEH_String("STFST01"), PU_STATIC));

    // dead face
    bstar = static_cast<decltype(bstar)>(W_CacheLumpName(DEH_String("STFDEAD0"), PU_STATIC));
}
