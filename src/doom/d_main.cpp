...
boolean D_Display (void)
{
    ...
    static  gamestate_t		oldgamestate = gamestate_t::GS_FLUSH_SCREEN;
	...
	oldgamestate = gamestate_t::GS_FLUSH_SCREEN;                      // force background redraw
	borderdrawcount = 3;
    }
...
//  M_BindIntVariable("vanilla_demo_limit",     &vanilla_demo_limit);
    ...
    for (i=0; i<10; ++i)
    {
        ...
        M_BindStringVariable(buf, const_cast<const char **>(&chat_macros[i]));
    }
