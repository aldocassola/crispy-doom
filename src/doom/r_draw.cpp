...
void R_InitTranslationTables (void)
{
    ...
    translationtables = static_cast<decltype(translationtables)>(Z_Malloc (256*3, PU_STATIC, 0));
...
void R_FillBackScreen (void)
{
    ...
    patch = static_cast<decltype(patch)>(W_CacheLumpName(DEH_String("brdr_l"),PU_CACHE));
    ...
    patch = static_cast<decltype(patch)>(W_CacheLumpName(DEH_String("brdr_r"),PU_CACHE));
